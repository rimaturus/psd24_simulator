...
#ifndef CONTROLLER_MANAGER_MSGS__MSG__CONTROLLER_STATE_H_
#define CONTROLLER_MANAGER_MSGS__MSG__CONTROLLER_STATE_H_
...
#endif  // CONTROLLER_MANAGER_MSGS__MSG__CONTROLLER_STATE_H_
