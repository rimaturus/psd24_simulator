...
{
  new (message_memory) psd_vehicle_interfaces::msg::ObstacleInfo(_init);
}

void ObstacleInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<psd_vehicle_interfaces::msg::ObstacleInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleInfo_message_member_array[5] = {
  {
    ...
    offsetof(psd_vehicle_interfaces::msg::ObstacleInfo, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(psd_vehicle_interfaces::msg::ObstacleInfo, shape),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(psd_vehicle_interfaces::msg::ObstacleInfo, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(psd_vehicle_interfaces::msg::ObstacleInfo, area),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(psd_vehicle_interfaces::msg::ObstacleInfo, frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleInfo_message_members = {
  "psd_vehicle_interfaces::msg",  // message namespace
  "ObstacleInfo",  // message name
  5,  // number of fields
  sizeof(psd_vehicle_interfaces::msg::ObstacleInfo),
...
{
  return &::psd_vehicle_interfaces::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, psd_vehicle_interfaces, msg, ObstacleInfo)() {
  return &::psd_vehicle_interfaces::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
