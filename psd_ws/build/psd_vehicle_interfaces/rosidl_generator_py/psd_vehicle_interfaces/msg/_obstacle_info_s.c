...
bool psd_vehicle_interfaces__msg__obstacle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("psd_vehicle_interfaces.msg._obstacle_info.ObstacleInfo", full_classname_dest, 54) == 0);
  }
  psd_vehicle_interfaces__msg__ObstacleInfo * ros_message = _ros_message;
  {  // name
...
PyObject * psd_vehicle_interfaces__msg__obstacle_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("psd_vehicle_interfaces.msg._obstacle_info");
